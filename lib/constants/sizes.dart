...
class Sizes {
  ...
  static double paddingBig = 0, paddingRegular = 0, paddingSmall = 0, paddingTiny = 0;
  ...
  static double buttonWidth = 0, buttonHeight = 0;
  ...
  void initialize(BuildContext context) {
    ...
    buttonWidth = widthPercent * 60;
    buttonHeight = heightPercent * 10;
  }
}